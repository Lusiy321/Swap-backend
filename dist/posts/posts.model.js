...
let Post = class Post extends mongoose_2.Model {
};
__decorate([
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'https://ldsound.info/wp-content/uploads/2013/07/25%D0%B0%D1%81128-ldsound_ru-1.jpg', description: 'Post avatar' }),
    (0, mongoose_1.Prop)({
        type: String,
...
], Post.prototype, "favorite", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({
